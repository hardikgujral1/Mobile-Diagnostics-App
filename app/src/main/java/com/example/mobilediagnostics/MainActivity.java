...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cpuInfoTextView = findViewById(R.id.cpu);
        memoryInfoTextView = findViewById(R.id.memory);
        batteryInfoTextView = findViewById(R.id.battery);
        sensorInfoTextView = findViewById(R.id.sensors);
        networkInfoTextView = findViewById(R.id.network);
